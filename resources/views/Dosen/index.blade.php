...
<body>
 ...
 <h1 class="main-title mb-1">Daftar Dosen</h1>
    ...
    <a href="{{ action([App\Http\Controllers\DosenController::class, 'create']) }}" class="btn btn-create btn-lg">+ Tambah Dosen</a>
@else
    <button type="button" class="btn btn-create btn-lg" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="menambah data dosen">+ Tambah Dosen</button>
@endif
        </div>
    </div>
             <div class="table-responsive-wrapper">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="badge bg-secondary text-white px-2 py-1">{{ $d->NIP }}</span></td>
...
<div class="d-flex justify-content-center gap-2">
                            <!-- LOGIKA TOMBOL EDIT & DELETE DOSEN -->
@if(auth()->user()->role === 'admin')
    <!-- Jika Admin: Bisa akses rute edit & destroy -->
...
@else
    <!-- Jika Dosen: Munculkan modal gembok -->
    <button type="button" class="btn btn-action-edit" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="mengedit data dosen">Edit</button>
    <button type="button" class="btn btn-action-delete" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="menghapus data dosen">Delete</button>
@endif
                            </div>
                        </td>
                    </tr>
