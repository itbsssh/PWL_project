        ...
        <div class="container my-5">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
                <div>
                    ...
                    <p class="text-white-50 mb-0">Kelola dan lihat seluruh data jurusan aktif </p>
                </div>
                <div>
<!-- LOGIKA TOMBOL TAMBAH  -->
@if(auth()->user()->role === 'admin')
    <a href="{{ action([App\Http\Controllers\JurusanController::class, 'create']) }}" class="btn btn-create btn-lg">+ Tambah Jurusan</a>
@else
    <button type="button" class="btn btn-create btn-lg" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="menambah data jurusan">+ Tambah Jurusan</button>
@endif
    </div>
    </div>
            <div class="table-responsive-wrapper">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $j->id }}</td>
                        <td class="fw-semibold text-white">{{ $j->nama_jurusan }}</td>
                        <td><span class="badge bg-secondary text-white px-2 py-1">{{ $j->kode_jurusan }}</span></td>
                        <td>{{ $j->created_at }}</td>
...
@else
    <button type="button" class="btn btn-action-edit" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="mengedit data jurusan">Edit</button>
    <button type="button" class="btn btn-action-delete" data-bs-toggle="modal" data-bs-target="#adminOnlyModal" data-fitur="menghapus data jurusan">Delete</button>
@endif
                            </div>
                        </td>
                    </tr>
